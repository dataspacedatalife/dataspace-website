        ...
        <div className="mb-10 lg:mb-0 lg:order-2 flex justify-center">
          <div className="relative w-full max-w-sm sm:max-w-md aspect-square">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-full bg-[#199AB6]/30 blur-3xl" />
            </div>
            ...
            <div className="relative w-full h-full rounded-3xl border border-white/30 bg-white/50 backdrop-blur-xl shadow-2xl">
              ...
              <svg className="absolute inset-0 w-full h-full">
                ...
                {/* líneas principales */}
                <line x1="50%" y1="50%" x2="50%" y2="15%" stroke="#199AB6" strokeWidth="5" opacity="0.5" />
                <line x1="50%" y1="50%" x2="15%" y2="85%" stroke="#199AB6" strokeWidth="5" opacity="0.5" />
                <line x1="50%" y1="50%" x2="85%" y2="85%" stroke="#199AB6" strokeWidth="5" opacity="0.5" />

                {/* conexiones secundarias */}
                <line x1="50%" y1="15%" x2="15%" y2="85%" stroke="#199AB6" strokeWidth="2.5" opacity="0.3" />
                <line x1="50%" y1="15%" x2="85%" y2="85%" stroke="#199AB6" strokeWidth="2.5" opacity="0.3" />
                <line x1="15%" y1="85%" x2="85%" y2="85%" stroke="#199AB6" strokeWidth="2.5" opacity="0.3" />

                {/* nodos */}
                <circle cx="50%" cy="15%" r="8" fill="#199AB6" opacity="0.85" />
                <circle cx="15%" cy="85%" r="8" fill="#199AB6" opacity="0.85" />
                <circle cx="85%" cy="85%" r="8" fill="#199AB6" opacity="0.85" />

                {/* centro de la red (SIN favicon) */}
                <circle cx="50%" cy="50%" r="10" fill="#199AB6" opacity="0.95" />

              </svg>

              {/* TEXTO ARRIBA */}
              <div className="absolute top-6 left-1/2 -translate-x-1/2 text-center">
                <div className="text-lg font-semibold text-[#199AB6]">
                  {t('graphic.human')}
                </div>
              </div>
