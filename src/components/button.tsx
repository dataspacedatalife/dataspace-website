...
const variants = {
  primary: clsx(
    ...
    'rounded-lg border border-transparent bg-gray-950 shadow-md', // ✅ esquinas redondeadas suaves
  ...
  secondary: clsx(
    ...
    'rounded-lg border border-transparent bg-white/15 shadow-md ring-1 ring-[#D15052]/15', // ✅ esquinas redondeadas
  ...
  outline: clsx(
    ...
    'rounded-lg border border-transparent shadow-sm ring-1 ring-black/10', // ✅ esquinas redondeadas
